...
public class i_connection {
    ...
    public i_connection() {
        /*
        this.strDriver = i_jdbc.getStringValue("jdbc.driver");//"org.postgresql.Driver"; //""
        this.strUrl = i_jdbc.getStringValue("jdbc.url");//"jdbc:postgresql://localhost:5432/dbvalores3";//"jdbc:postgresql://10.10.21.9:5432/dbvalores3";
        this.strUser = i_jdbc.getStringValue("jdbc.user");//"postgres";
        this.strPassword = i_jdbc.getStringValue("jdbc.password");//"postgres";
        */
        
        this.strDriver = "org.postgresql.Driver";
        this.strUser = "budgetppto";
        this.strPassword = "p23tion0112358";
        this.strUrlServer = "jdbc:postgresql://localhost:5432/";
        this.strDataBase = "dbidh";
        /*
        this.strDriver = "org.postgresql.Driver";
        this.strUser = "postgres";
    ...
    public i_connection(String strDriver, String strUrl, String strUser, String strPassword) {
  ...
  /*  public static void main(String arg[]) {
        ...
        i_connection conenxion = new i_connection();
        
        try {
            conenxion.connection();
            rsResultado = conenxion.executeQuery("SELECT * FROM categoria");
            while(rsResultado.next()) {
                System.out.println(rsResultado.getString("descrip"));
            }
        } catch (ClassNotFoundException e) {
        ...
        i_connection conenxion2 = new i_connection();
