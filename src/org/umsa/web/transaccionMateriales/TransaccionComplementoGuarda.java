 ...
 * @author julian
 */
public class TransaccionComplementoGuarda implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        System.out.println("Desde Trans Compl Guarda --> "+cod_w);
        ...
        Transaccion comp = new Transaccion();
        comp.setCod_trans_detalle(cod_trans_detalle);
        comp.setDetalle(complemento);

        this.adqui.setTransaccionComplemento(comp);
