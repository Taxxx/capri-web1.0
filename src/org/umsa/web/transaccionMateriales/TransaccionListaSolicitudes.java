...
public class TransaccionListaSolicitudes implements Controller {
...
//    Recuperamos las variables
    ...
    PagedListHolder listaSolicitudes = new PagedListHolder(this.adqui.getTransaccionListaSolicitudes(trans));
    listaSolicitudes.setPageSize(listaSolicitudes.getNrOfElements());    
            
    Map modelo = new HashMap();
    modelo.put("ListSolicitudes",listaSolicitudes);
    modelo.put("tipo_tramite",tipo_tramite);
    modelo.put("cod_tramite",cod_tramite);
    return new ModelAndView("transaccionMateriales/TransaccionListaSolicitudes", modelo);
