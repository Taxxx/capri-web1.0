...
public class TransaccionConsultoresAdjTerminos implements Controller {
...
//aumentado
    ...
    //    System.out.println("entro a__"+request.getParameter("auxiliar"));
        ...
        System.out.println("Hasta aqui sin problemas1");
        //fu.setRepositoryPath("/tmp");
        fu.setRepositoryPath("c:\\tmp");
        System.out.println("Hasta aqui sin problemas2");
        System.out.println(request.getParameterMap());
        //isMultipart = ServletFileUpload.isMultipartContent(request);
        List fileItems = fu.parseRequest(request);
        System.out.println("Hasta aqui sin problemas3");
