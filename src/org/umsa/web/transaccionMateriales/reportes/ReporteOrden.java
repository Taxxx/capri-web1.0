...
public class ReporteOrden extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        try {                        
            ...
            System.out.println("El getServletConfig es: "+this.getServletConfig());
            ServletContext context = this.getServletConfig().getServletContext();
            System.out.println("El context es: "+context);
            ...
            reportFile = new File(context.getRealPath("/Reportes/OrdenCompra.jasper"));                        
            ...
            try{
                ...
                Map[] datos=puerto.getReporteOrdenx(Integer.parseInt(cod_trans_nro),cod_estado,2);    
                if (datos!=null){                 
                    Map map = new HashMap();
                    int i=0;
