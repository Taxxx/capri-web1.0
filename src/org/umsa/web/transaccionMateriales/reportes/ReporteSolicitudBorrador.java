 ...
 * @author UMSA-JES
 */
public class ReporteSolicitudBorrador extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            reportFile = new File(context.getRealPath("/Reportes/SolicitudCompraBorrador.jasper"));                        
            ...
            try{
                ...
                Map[] datos=puerto.getReporteSolicitudBorrador2(Integer.parseInt(cod_transaccion));
