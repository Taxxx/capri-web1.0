 ...
 * @author UMSA-JES
 */
public class ReporteOrdenBorrador extends HttpServlet {
...
//            System.out.println("cod_trans_nro: "+cod_trans_nro);
            ...
            reportFile = new File(context.getRealPath("/Reportes/OrdenCompraBorrador.jasper"));                        
            ...
            try{
                ...
                Map[] datos=puerto.getReporteOrdenDescargo(Integer.parseInt(cod_transaccion),cod_estado,2);    
                if (datos!=null){                 
                    Map map = new HashMap();
                    int i=0;
