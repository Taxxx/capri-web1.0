 ...
 * @author UMSA-JES
 */
public class LoadDetalle implements Controller{
    @Override
...
//                     System.out.println("5 - "+e[f].get("DETALLE_ALM").toString());
                     ...
                     JSNDetalle.put("cod_complemento", e[f].get("COD_COMPLEMENTO").toString());
                     JSNDetalle.put("cod_trans_detalle", e[f].get("COD_TRANS_DETALLE").toString());
                     JSNDetalle.put("detalle_solicitud", e[f].get("DETALLE_SOLICITUD").toString());
                     JSNDetalle.put("detalle_adqui", e[f].get("DETALLE_ADQUI").toString());
                     JSNDetalle.put("detalle_alm", e[f].get("DETALLE_ALM").toString());
             ...
             Listado.put("ListaDetalle", datos);
