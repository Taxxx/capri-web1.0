 ...
 * @author UMSA-JES
 */
public class GetTipoItem implements Controller{
    @Override
           ...
           AdquiWSServiceLocator servicio = new AdquiWSServiceLocator();
            ...
            if (e!=null){
                ...
                //else{aux=(Proveedor) i.next();}
                    ...
                    JSNProveedor.put("cod_tipo_item", e[f].get("COD_TIPO_ITEM").toString());
...
//                    JSNProveedor.put("adh_tipo", e[f].get("NOMBRE").toString());
                ...
                Listado.put("List_TipoItem", datos);
