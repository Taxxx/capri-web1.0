package org.umsa.web.herramientas;
/**
...
*/
public class NumerosTextuales {

    public NumerosTextuales() {
    }
...
// Valor por defecto "" . O sea que si la parte entera == 0 no se incluye nada
        NumerosTextuales.setPalabra_cero("CE|RO");
...
// se pasa a false
        NumerosTextuales.setCantidad_decimales(2);
...
// valor 0 , traduce a "UNO" (valor por defecto) , valor 1 traduce a "UNA" y valor 2 a "UN"
        NumerosTextuales.setGenero_unidad(0);
...
// seria mas logico " CEN|TA|VOS.-"
        //NumerosTextuales.setSufijo_decimales("MIL|MI|LLO|NE|SI|MOS.-");
        
        NumerosTextuales.setSufijo_decimales("|/100.-");
...
// COMPLETA AL RENGLON SIGUIENTE        
        NumerosTextuales.setSufijo_enteros("");
        
// Fija el texto a agregar al final        
        NumerosTextuales.setSufijo_final("");
...
// haya que seguir en el proximo se completaran con el caracter "-"        
       NumerosTextuales.setCaracter_proteccion(' ');
       
// Esta es la cifra que produce el texto mas largo (independientemente de los textos agregados)
        // String importe = "3245.0";
        String importe = Double.toString(num);       
...
// usando el metodo que recibe un double cuando la cantidad es muy grande
        String[] texto = NumerosTextuales.getTexto(importe);
        String text="";
 ...
 /*       double cantidad = 1.0;
        ...
        texto = NumerosTextuales.getTexto(cantidad);
        for ( int i = 0 ; i < texto.length; i++ )   {
...
// El valor traducido de los decimales difiere de los pasados
        ...
        NumerosTextuales.setPrefijo_inicio("(");
        NumerosTextuales.setSufijo_final(")");
        NumerosTextuales.setCantidad_decimales(6);
        NumerosTextuales.setCaracter_proteccion('-');
        NumerosTextuales.setSufijo_decimales("MI|LI|GRA|MOS.-");
        NumerosTextuales.setSufijo_enteros("KI|LO|GRA|MOS");
        texto = NumerosTextuales.getTexto(cantidad);
        for ( int i = 0 ; i < texto.length; i++ )   {
            System.out.println(texto[i]);
        }*/
