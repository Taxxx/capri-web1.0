...
<html>
                        ...
                        $("#formu_prob").submit(function(){
                           ...
                           --%>
                            ...
                            $("#formu_prob").attr("action",'<c:url value="/TransaccionConsultorAdjTerminos.umsa">
                                    ...
                                    <c:param name="cod_transaccion" value="${cod_transaccion}"/> 
                                    <c:param name="tipo_tramite" value="${tipo_tramite}"/>
                                    <c:param name="tipo_transaccion" value="obras"/> 
    ...
    <form name='forma' action='<c:url value="/TransaccionObrasDetalle.umsa"/>' id="formu_prob" method='post' >
                    ...
                    <tbody>
                        <c:forEach var="lista" items="${listaTransaccionArticulos.pageList}" varStatus="contador">                            
                                <c:if test="${lista.tipo_item == null }">
                                    ...
                                    <td></td>
                                    <td></td>
                                    <%--<td><a href="<c:url value="./docs/${lista.terminos_ref}"></c:url>" style="color:green">${lista.terminos_ref}</a> </td>
                        ...
                        <%--<c:if test="${!empty listaTransaccionArticulos.pageList}">
                            <tr>
                                <td colspan="6"><p>                   
                                <label>Especificacion Tecnica: </label>
                                <input type="file" name="archivo" size="60"/>
                                <input type="submit" value="Adjuntar" 
                                onclick="document.forma.action='<c:url value="/TransaccionObraAdjTerminos.umsa">
                                <c:param name="cod_tramite" value="${cod_tramite}"/>                            
                                <c:param name="cod_w" value="${cod_w}"/> 	      
                                <c:param name="cod_transaccion" value="${cod_transaccion}"/> 
                                <c:param name="tipo_tramite" value="${tipo_tramite}"/>
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
                <tr>
                    <td class="gridContent">
                        ...
                        <input type=submit name="BtnTerminar" value="Terminar Solicitud" onclick="document.forma.action='<c:url value="/TransaccionObrasBandeja.umsa"><c:param name="cod_w" value="${cod_w}"/><c:param name="cod_tramite" value="${cod_tramite}"/> </c:url>'" >                                                                       
                    </td>
                </tr>
            </table>            
        </div>
