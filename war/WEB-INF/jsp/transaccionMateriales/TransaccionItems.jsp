...
<html>
    <head>
        ...
        <script type="text/javascript">
            <%--alert(<% String x= "document.write(document.getElementById('descripcion_doc')";out.print(x); %>);--%>
            //alert(":D");
            ...
            $("#dialog_poa").dialog({
                ...
                $("#pres").on("click",function(){
                    ...
                    if( ($("#archivo_adjunto").val()!='') && ($("#descripcion_doc").val()!='') && ($("#tipo_doc").val()!='')){
                        ...
                        alert("Debe Seleccionar un Archivo y ademas Su descripcion¡¡¡");
                    }   
                });
            }
            function setBuscar(){
    ...
    <div class="container_cuerpo">
        ...
        <div class="box">
            <h2>
                <a href="#" id="toggle-tables">Datos Generales ${tipo_tramite} Gestion: <c:out value="${nro_gestion}"/> -- TIPO CUANTIA :: <c:out value="${cuantia}"/></a>
            </h2>
                ...
                <table>
                    ...
                    <c:if test="${!empty listaTransaccionArticulos.pageList}">
                            <tr>
                                ...
                                <input type="text" style="width: 200px;" name="descripcion_doc" id="descripcion_doc"/>
                                <%--
                                ...
                                <c:param name="tipo_transaccion" value="solicitud_compras"/> 
                                    ...
                                    document.forma.enctype='multipart/form-data'
                                "/>
                                --%>
                                ...
                                <select name="tipo_doc" id="tipo_doc">
                                    ...
                                    <option value="2">Formulario de Solicitud de Compra</option>
                                    <option value="3">Nota de Solicitud</option>
                                    <option value="4">Hoja de Ruta</option>
                                    <option value="5">Cotización</option>
                                    <option value="6">Factura</option>
                                    <option value="7">Nota de Conformidad</option>
                                    <option value="8">Nota de Solicitud de Pago</option>
                                    <option value="9">Contrato</option>
                                    <option value="10">Terminos de Referencia</option>
                                </select>
                                -->
                                <select name="tipo_doc" id="tipo_doc">
                                    <option value="">Ninguno</option>
    ...
    <div class="grid_16">
        <div class="box">
            ...
            <%--<input type="text" name="nat" value="${nat}" id="nat"/>--%>
            <%--Buscar Item : <input type="text" name="search" value="${search}" id="search"><input class="button-submit" type="submit" name="opcion" value="Buscar" id="Buscar" onclick="javascript:return setBuscar()">--%>
                ...
                <tr>
                    <td class="gridContent">
                        ...
                        <c:if test="${cod_tramite==1}">                            
                            <input type=submit name="BtnTerminar" value="Terminar Solicitud" onclick="document.forma.action='<c:url value="/TransaccionMateriales.umsa"/>'" >
                        </c:if>
                        <c:if test="${cod_tramite==4}">                            
                            <input type=submit name="BtnTerminar" value="Terminar Pedido" onclick="document.forma.action='<c:url value="/TransaccionPedidos.umsa"/>'" >
                        </c:if>
                    </td>
                </tr>
            </table>            
        ...
        <div id="header_buscadorAvanzado">
            <div id="busca_partida">
                <select name="thelist" id="combo_partidas">
                    <option>Escoja una Partida</option>
                    <option>two</option>
                    <option>three</option>
                </select>
            </div>
